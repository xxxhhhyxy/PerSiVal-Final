        ...
        public void ApplyBodyPose(ARHumanBody body)
        {
            ...
            for (int i = 0; i < k_NumSkeletonJoints; ++i)
            {
                ...
                if (bone != null)
                {
                    ...
                    if (i == 20)
                        GlobalCtrl.M_TrackManager.LShoulder = bone.transform.position;
                    if (i == 21)
                        GlobalCtrl.M_TrackManager.LElbow = bone.transform.position;
                    if (i == 22)
                        GlobalCtrl.M_TrackManager.LWrist = bone.transform.position;
                    if (i == 64)
                        GlobalCtrl.M_TrackManager.RShoulder = bone.transform.position;
                    if (i == 65)
                        GlobalCtrl.M_TrackManager.RElbow = bone.transform.position;
                    if (i == 66)
                        GlobalCtrl.M_TrackManager.RWrist = bone.transform.position;
                }
            }
        }
